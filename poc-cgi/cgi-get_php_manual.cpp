...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   cgi-get_php_manual.cpp                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: nrea <nrea@student.42.fr>                  +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/25 11:58:15 by nrea              #+#    #+#             */
/*   Updated: 2024/10/04 16:53:47 by nrea             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char const **argv, char **env)
{
	...
	header_infos header;
	header.toDo = GET_CGI;
	header.ressourcePath = "./cgi-get_manual.php";
	header.interpreterPath = "/usr/bin/php";
	...
	header.envMap["SCRIPT_NAME"]= "cgi-get.php";
	header.envMap["QUERY_STRING"]= "first_name=Nicolas&last_name=Rea";
	...
	// header.envMap["REDIRECT_STATUS"]= "1"; // Obligatoire pour php-cgi
	// std::string script_wrapper = "/home/nrea/Documents/PROJETS/webserv/github/poc-cgi/cgi-get.php";
	// script_wrapper += ".cgi";
	// header.envMap["SCRIPT_FILENAME"]= script_wrapper; // Obligatoire pour php-cgi
